...
import { getQueryParams, getBodyParams, getPathParams, getPathParamsTyped, getParamsTyped, } from './params';
...
const getServiceEndpoint = (path: string, httpMethod: MethodType, details: ReduxApiEndpointType): any => {
...
const getSliceEndpoint = (path: string, httpMethod: MethodType, details: any): any => {
...
const getThunkEndpoint = (path: string, httpMethod: MethodType, details: any): any => {
...
class Endpoint {
  ...
  constructor(endpointType: EndpointType, path: string, httpMethod: MethodType, details: ReduxApiEndpointType) {
    ...
    const { interfaceName: paramInterfaceName, modelName: paramModelName, paramName: iNameParam } = getNames(details);
    ...
    this._joinedParams = this._pathParams.concat(this._queryParams).concat(this._bodyParams);
